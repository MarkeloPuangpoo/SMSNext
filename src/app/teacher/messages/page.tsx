      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2 ml-1">
            ส่งข้อความและติดต่อสื่อสารกับนักเรียน
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="border-0 shadow-2xl bg-white rounded-3xl overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-pink-500 via-rose-500 to-pink-600 text-white p-6 border-b-4 border-rose-200">
              <CardTitle className="text-xl font-bold">รายชื่อนักเรียน</CardTitle>
              ...
              <div className="max-h-[600px] overflow-y-auto">
                {filteredContacts.length === 0 ? (
                  <div className="text-center py-12 text-gray-500">
                    <p className="text-lg font-medium">ไม่พบนักเรียน</p>
                    <p className="text-sm mt-2">ยังไม่มีนักเรียนในห้องเรียนของคุณ</p>
                  </div>
                ) : (
            ...
            {selectedContact ? (
              <>
                <CardHeader className="bg-gradient-to-r from-pink-500 via-rose-500 to-pink-600 text-white p-6 border-b-4 border-rose-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription className="text-rose-50 text-sm">
                        นักเรียน
                      </CardDescription>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  {/* Messages List */}
                  <div id="messages-container" className="h-[400px] overflow-y-auto mb-4 space-y-4">
                    {messages.length === 0 ? (
              ...
              <div className="flex items-center justify-center h-full py-32">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-lg font-medium">เลือกนักเรียนเพื่อเริ่มสนทนา</p>
                  <p className="text-gray-400 text-sm mt-2">คลิกที่รายชื่อนักเรียนด้านซ้าย</p>
                </div>
              </div>
            )}
          </Card>
